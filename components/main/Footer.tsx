      ...
      <div className="w-full flex flex-col items-center justify-center m-auto">
        <div className="w-full h-full flex flex-row items-center justify-around flex-wrap">
          ...
          <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
            ...
            <p
              className="flex flex-row items-center my-[15px] cursor- +
                    pointer"
            >
              <RxDiscordLogo />
          ...
          <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
            <div className="font-bold text-[16px]">acerca de</div>
            <p className="flex flex-row items-center my-[15px] cursor-pointer">
              <span className="text-[15px] ml-[6px]">Patrocinador</span>
            </p>
            <p className="flex flex-row items-center my-[15px] cursor-pointer">
              <span className="text-[15px] ml-[6px]">sobre nosotros</span>
            </p>
            <p className="flex flex-row items-center my-[15px] cursor-pointer">
              <span className="text-[15px] ml-[6px]">
                maxhenry2023n@gmail.com
              </span>
            </p>
          </div>
        </div>
        ...
        <div className="mb-[20px] text-[15px] text-center">
          &copy; 2023 Inc. Todos los derechos estan reservados
        </div>
      </div>
    </div>
  );
